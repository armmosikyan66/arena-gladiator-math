"""Regenerate Earn classic pick_6 books/LUTs (flatten 9.9 -> 200 last-step cliff)."""
...
if __name__ == "__main__":
    ...
    paying = paying_from_table(config.keno_earn_paytable["classic"][6])
    name = "classic_pick_6_earn"
    num_sim_args = {name: book_count_for_picks(6, paying=paying)}
