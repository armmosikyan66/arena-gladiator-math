"""Regenerate Earn medium pick_4 books/LUTs (flatten 3-hit -> 4-hit cliff)."""
...
if __name__ == "__main__":
    ...
    paying = paying_from_table(config.keno_earn_paytable["medium"][4])
    name = "medium_pick_4_earn"
    num_sim_args = {name: book_count_for_picks(4, paying=paying)}
