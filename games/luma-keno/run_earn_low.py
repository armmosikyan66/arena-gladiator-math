"""Regenerate Earn `low` books/LUTs (picks 1-10). Off and buy stay put."""
...
if __name__ == "__main__":
    ...
    num_sim_args = {}
    for k in range(1, 11):
        paying = paying_from_table(config.keno_earn_paytable["low"][k])
        num_sim_args[f"low_pick_{k}_earn"] = book_count_for_picks(k, paying=paying)
